...
void setupLocator() {
  ...
  locator.registerLazySingleton(() => DBoardNotificationApi());
  locator.registerFactory(() => DashBoardNotificationViewModel());
...
final List<SingleChildWidget> allProviders = <SingleChildWidget>[
  ...
  ChangeNotifierProvider<DashBoardNotificationViewModel>(
      create: (_) => DashBoardNotificationViewModel()),
