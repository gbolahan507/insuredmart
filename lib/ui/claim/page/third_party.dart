...
class ThirdPartyClaim extends StatefulWidget {
  ThirdPartyClaim({
    Key key,
  }) : super(key: key);

  @override
  _ThirdPartyClaimState createState() => _ThirdPartyClaimState();
}

class _ThirdPartyClaimState extends State<ThirdPartyClaim> {
      ...
      return Container(
        child: Column(
          children: [
            ...
            CustomTextField(
              title: 'Description of damaged property',
...
//    var dir = await path_provider.getTemporaryDirectory();
  ...
  String heads(int i) {
    ...
    return headl.thirdPartyClaimHeading;
  }
}
