  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        Row(
          children: [
            CustomText('Which insurance do you want to get', color: Styles.appBackground2, fontSize: 14,),
          ],
        ),
        verticalSpaceSmall,
        ListView.builder(
          ...
          itemBuilder: (context, index){
            ...
            return HomePageBox(
              ...
              onPressed: (){
  Navigator.push(context, MaterialPageRoute(builder: (context) => CarUploadScreen1()));
...
class HomePageBox extends StatelessWidget {
  ...
  const HomePageBox({
    Key key, this.image, this.status, this.title,  this.hompage, this.contents, this.onPressed,
  }) : super(key: key);
    ...
    return InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                CustomText('$title', fontSize: 14, color: Styles.colorWhite, ),
                 horizontalSpaceTiny,
               status == false ?
                   Container(
                  ...
                  child: CustomText('coming soon', fontSize: 10, color: Styles.colorWhite, ),
                ) 
                :
            ...
            verticalSpaceSmall,
            CustomText('$contents',  textAlign: TextAlign.left, textheight: 1.5, fontSize: 12, color: Styles.colorLemon, )
