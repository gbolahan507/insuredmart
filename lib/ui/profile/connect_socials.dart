          ...
          child: ListView(
            children: [
              ...
              ConnectContainer(
                  ...
                  status:
                      choose.googleconnected ? 'Connected' : 'Not connected',
                  onPressesd: () {
                    choose.togglegoogle();
              ...
              ConnectContainer(
                  ...
                  title: 'Facebook',
                  status:
                      choose.facebookconnected ? 'Connected' : 'Not connected',
                  onPressesd: () {
                    choose.tooglefacebook();
                    choose.facebookconnected ? print('true') : print('fasle');
                  }),
            ],
          ),
        ),
