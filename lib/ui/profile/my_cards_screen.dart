                 ...
                 children: [
                   ...
                   Row(
                     children: [
                       InkWell(
                         onTap: (){},
                         child: CustomText('Edit Card', fontSize: 14, color: Styles.appBackground1,  )),
                       horizontalSpaceMedium,
                       InkWell(
                         onTap: (){
                            print(choose.cards[index].id.toString());
                            print(choose.cards.length);
                            onRemove(choose.cards[index]);
                            print(choose.cards.length);
                         },
                         child: CustomText('Delete Card', fontSize: 14, color: Styles.colorRed,  )),
                       Spacer(),
                       DotCircle(
